...
CONFIG = {
    "testname": "C128 Text 80 Col",            # nickname for 
    "projdir": "textprint80col", 
    "cmainfile": "text80col",                # c-file progname no extenion to give to compiler
    ...
    "viceconf": "vice_c128conf.cfg",     # sound conf location, assume this starts at PATHS["projdir"]
    "linkerconf": "",
