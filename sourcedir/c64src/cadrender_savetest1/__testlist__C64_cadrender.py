...
CONFIG = {
    "testname": "cadrender",
    "projdir": "cadrender",            # projects main parent dir name, also used for testlist sorting
    "cmainfile": "main",                # c-file progname no extenion to give to compiler
    "testtype": "savetest",                # name for this test type, used to make new run-button of like-named tests
